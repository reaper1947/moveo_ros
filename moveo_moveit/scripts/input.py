...
gripper = {'open': 0, 'box': 70, 'cylinder': 50}
upright = [0, 0, 0, 0, 0, 0]

#predefined movements for pick and place of an apple and banana
box_pick = [0, -2243, -23410, 14, -800, gripper['box']]
box_move = [0, -1113, -17410, 14, -3300, gripper['box']]
box_place = [-4600, -2400, -18410, 91, -800, gripper['open']]

cylinder_pick = [0, -2243, -24410, 14, -400, gripper['cylinder']]
cylinder_move = [0, -1043, -17410, 14, -3300, gripper['cylinder']]
cylinder_place = [4600, -2400, -20410, -91, -400, gripper['open']]


object_trajectories = {"box": [upright, box_pick, box_move, box_place, upright],
                       "cylinder": [upright, cylinder_pick, cylinder_move, cylinder_place, upright]}
